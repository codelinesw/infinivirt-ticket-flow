...
import { useSignUpViewModel } from './sign-up-view-model';
...
export const SignUp: React.FC<SignUpProps> = () => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-[550px] bg-white p-10 rounded-[5px] transform transition-all duration-300 ease-out">
        ...
        <form onSubmit={viewModel.handleSubmit(viewModel.createUser)} className="space-y-4">
            ...
            <Controller
              ...
              render={({ field }) => (
                <Input
                  ...
                  Icon={<UserIcon className="absolute left-2 top-1/2 -translate-y-1/2 w-5 h-5 text-neutral-500 transition-colors group-focus-within:text-blue-400" />}
                  value={field.value}
